...
<html>
  <head>
    ...
    <meta content='Fajar Web Developer' name='description'/>
    <meta content='Uploader Free - © RahmX403' name='keywords'/>
    <meta content="Uploader Free - © RahmX403" name="author" />
    <meta content="Uploader Free - © RahmX403 - All Right Reserved" name="copyright" />
    <meta content='Uploader HaxorBucin - © RahmX403' name='twitter:image:alt'/>
    <meta content='' name='twitter:image:src'/>
    <title>Fajar Dev Hosting</title>
    <link href='' rel='manifest'/>
    <link href='' sizes='120x120'/>
    <link href='' sizes='152x152'/>
    <link href='' sizes='180x180'/>
  ...
  <style type="text/css" media="all">
    ...
    .head.haxor{white-space: pre-wrap;font-size: 38px;padding: 8px 0px 0px 0px;margin: 0;letter-spacing: 0px;color: #a67eff;}
    .head.haxor{font-size:27px;} .natsprinsleylinks {font-size:15px;padding:8px;margin:6px 0px;}}
  </style>
  <body>
  <center>
      <a href="https://pajardev.github.io">
      <h1 class='head haxor'>FAJAR DEV</h1>
      </a>
      <div style="margin: 0px 0px 10px 0px;border: solid 1px #4b4b96;unicode-bidi: unset;overflow: unset;display: block;width: 99%;"></div>
    </center>
          ...
          if(isset($_FILES['htmlFile'])) {
            ...
            if($fileExt != "html"){
              ...
              <div class="col-12 mt-3">
                <div class="alert alert-danger">Hanya Bisa Upload Html, Gif, Txt, MP3, Htm.
                </div>
              </div>
              <?php
              exit();
    ...
    <script type="text/javascript" charset="utf-8">
      ...
      function share() {
        if (navigator.share) {
          navigator.share({
            title: 'Uploader Free - © RahmX403',
            text: 'Uploader Free - © RahmX403',
